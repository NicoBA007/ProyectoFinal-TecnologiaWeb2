        ...
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            <div class="bg-gray-900 border border-gray-800 p-8 rounded-2xl shadow-2xl">
                ...
                <h2 class="text-2xl font-black text-white mb-6 uppercase tracking-tighter">
                    Editar Talento: <span class="text-red-600">{{ $persona->nombre_completo }}</span>
                </h2>
                ...
                <form action="{{ route('personas.update', $persona->id_persona) }}" method="POST">
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nombre_completo" value="{{ old('nombre_completo', $persona->nombre_completo) }}"
                    ...
                    <div class="mb-5">
                        ...
                        <input type="text" name="nacionalidad" value="{{ old('nacionalidad', $persona->nacionalidad) }}"
                            class="w-full bg-gray-800 border-gray-700 text-white rounded-xl p-3 focus:ring-2 focus:ring-red-600 outline-none transition-all">
                    </div>

                    <div class="mb-5">
                        <label class="block text-gray-500 text-xs font-bold mb-2 uppercase">URL de la Foto</label>
                        <input type="url" name="foto_url" value="{{ old('foto_url', $persona->foto_url) }}"
                            class="w-full bg-gray-800 border-gray-700 text-white rounded-xl p-3 focus:ring-2 focus:ring-red-600 outline-none transition-all"
                            required>
                    </div>
