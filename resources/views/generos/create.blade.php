<div class="bg-gray-950 border border-white/5 p-8 rounded-[2.5rem] mb-10 shadow-2xl relative overflow-hidden group">
    ...
    <div class="absolute -top-24 -right-24 w-48 h-48 bg-red-600/5 rounded-full blur-[80px] group-hover:bg-red-600/10 transition-all duration-700"></div>
    ...
    <div class="flex items-center justify-between mb-6 relative z-10">
        <div class="flex items-center gap-4">
            ...
            <div>
                <h3 class="text-white font-black uppercase tracking-[0.3em] text-[11px]">Inducción de Categorías</h3>
            </div>
        </div>
        <div class="hidden md:block text-right">
            <span class="text-[7px] font-mono text-gray-800 uppercase tracking-[0.4em]">Ready for input...</span>
        </div>
    </div>
    ...
    <form id="formCrear" onsubmit="guardarData(event)" class="flex flex-col md:flex-row gap-4 items-stretch relative z-10">
        <div class="flex-1 relative group/input">
            ...
            <input type="text" id="nombre" placeholder="EJ: CIENCIA FICCIÓN, TERROR..." required 
        ...
        <button type="submit" 
            class="bg-red-600 hover:bg-red-700 text-white font-black px-12 py-4 rounded-2xl transition-all uppercase tracking-[0.3em] text-[11px] shadow-[0_10px_30px_rgba(220,38,38,0.2)] active:scale-95 flex items-center justify-center">
            Guardar
        </button>
    </form>
    ...
    <div class="mt-6 flex items-center gap-2 opacity-20">
        ...
        <div class="text-[7px] font-mono text-gray-500 uppercase tracking-[0.5em]">Metadata Entry Point</div>
